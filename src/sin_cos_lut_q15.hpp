...
constexpr int32_t abs_i32(int32_t x) noexcept {
        return (x < 0) ? -x : x;
}
...
static_assert(close_q15(sine_q15_14bit[THREE_QTR], static_cast<int16_t>(-Q15_ONE), TOL_ONE), "sin(3pi/2) should be ~-1");
