...
void PMSM_Controller::update(float& dutyA, float& dutyB, float& dutyC) {
...
void PMSM_Controller::directionCalibration(uint32_t& perA, uint32_t& perB, uint32_t& perC) {
        ...
        } else if (timerCounter > neededTicks && directionCalibrationState == DirectionCalibrationState::CALIBRATE_CCW) {
                timerCounter = 0;
